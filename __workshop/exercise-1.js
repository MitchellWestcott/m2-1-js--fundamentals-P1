...
function question5() {
  ...
  // 5.2. [[], 24, 'hello', true]
  console.log("5.2. Number of elements (3)", [null, number, string, boolean]);

  // 5.3. []
  console.log("5.3. Number of elements (0)", null);

  // 5.4. [['romeo', 'juliet'], false]
  console.log("5.4. Number of elements (3)", [[string, string] boolean]);

  // 5.5. [{name: 'bob', age: 23}, {name: 'paul', age: 33}]
  console.log("5.5. Number of elements (4)", [{obj: string, obj: number}, {obj: string, obj: number}]);
}
